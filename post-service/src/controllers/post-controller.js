...
const getPost = async (req, res) => {
  try {
    ...
    res.status(200).json({success:true,message:"Fetched post!",singlePostDetailsbyId});
  } catch (error) {
